...
import { logErrors, logInfo } from "../utils/logger.js";
import { extractJsonObjectFromText } from '../utils/parserUtils.js';
import { shortenHTML } from "../utils/shortenHtmlUtils.js";
import { connectToClickHouse } from "../modules/db/db.js"
...
class Scraper {
    ...
    async savePromotion(params) {
        ...
        await db.insert({
            table: 'behamics.competitor_promotions',
